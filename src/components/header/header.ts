...
export class Header {
  ...
  constructor() {
    ...
    const HEADER_TEMS = createAndAppendHtmlElement(this.header,"div","header__wrapper");
    ...
    this.register_button =createAndAppendHtmlElement(HEADER_TEMS, "button", "header__button", "register new player");
  }
}
